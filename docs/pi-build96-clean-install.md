...
Download the R5 Build 96 installer from [Apollo Downloads](https://www.repeaterbooklive.com/apollo/downloads/), verify its SHA-256, and run it with `sudo` from an interactive SSH terminal. It creates the loopback owner UI. Keep the installer-provided SSH tunnel open while completing setup.
