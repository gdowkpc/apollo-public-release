...
| --- | --- | --- | --- |
| Windows x64 | Apollo Passive Receive 1.0.0 Beta 1, Build 93 | [Windows owner guide](docs/windows-beta1.md) | [Download package](https://github.com/gdowkpc/apollo-public-release/releases/download/windows-v1.0.0-beta1-build93-r3/ApolloPassiveReceive-1.0.0-build.93-windows-x64.zip) |
...
The original Build 93 ZIP container remains available under an explicitly
historical asset name. The refreshed Build 93 download contains the qualified
runtime plus the owner-facing local UI shortcut and navigation improvements in a
Windows Explorer-compatible ZIP.
